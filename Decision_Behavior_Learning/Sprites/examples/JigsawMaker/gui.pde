...
void createGUI() {
  ...
  pnlStage1.setCollapsable(false);
  pnlStage1.setVisible(true);
  ...
  txfTitle.setDefaultText("Jigsaw title?");
  txfTitle.addEventHandler(this, "txfName_enter");
  lblDest = new GLabel(this, 10, 70, 40, 20, "Folder");
  ...
  pnlStage2.setCollapsable(false);
  ...
  e = new String[] { 
    "gridcol0.png", "gridcol1.png", "gridcol2.png"
  };
  ...
  pnlStage3.setCollapsable(false);
